...
def mkRmCases(baseCase, cases, isWriteDir=False):
    ...
    with open("rmCases", "w") as _rmCasesFile:
        ...
        _rmCasesFile.write(
            "\nmv %s %s\n"
            % (os.path.join(baseCase, "baseCase", "*"), os.path.join(baseCase, ""))
        )
...
def mkAllRunClean(baseCase):
    ...
    with open("Allrun", "w") as _allrunFile:
        # write script head
        _allrunFile.write(
            "# OpenFOAM Allrun script to run all cases generated" " by CaseFOAM\n\n"
        )
    ...
    with open("Allclean", "w") as _allcleanFile:
        # write script head
        _allcleanFile.write(
            "# OpenFOAM Allclean script to clean all cases" " generated by CaseFOAM\n\n"
        )
